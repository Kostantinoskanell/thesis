"""Roll out the trained Go2 policy and check it tracks a velocity command.

Same shape as rollout_go1.py, pointed at our ported Go2JoystickFlatTerrain env.
...
Usage:  python rollout_go2.py --vx 1.0 --steps 500
"""
...
def main():
    ...
    ap.add_argument("--out", default="/mnt/c/Users/hapos/Desktop/thesis/assets/go2_rollout.npz")
    args = ap.parse_args()
