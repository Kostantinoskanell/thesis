...
Verbatim port of mujoco_playground's go1_randomize.domain_randomize. The
logic is purely index-based (floor geom / torso body / first 12 DOFs after
the freejoint), not name-based, and our scene file mirrors Go1's structure
(floor geom attached directly to worldbody, single robot body next) --
so FLOOR_GEOM_ID=0 and TORSO_BODY_ID=1 hold unchanged for Go2 too.
"""
