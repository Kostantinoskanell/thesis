"""Base MJX env class for Go2 -- direct port of Playground's go1_base.Go1Env.

Unlike Go1's env (which uses a <position> actuator and overrides gainprm/
biasprm from a config Kp/Kd), Go2's Menagerie XML already bakes in tuned PD
gains via a <general> affine-bias actuator (gainprm="50 0 0" biasprm="0 -50
-0.5" -- i.e. kp=50, kd=0.5), so this class does not override actuator gains.
"""
