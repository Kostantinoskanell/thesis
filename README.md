...
Full proposal: [`proposal/proposal.tex`](proposal/proposal.tex) &middot;
Full milestone plan: [`ROADMAP.md`](ROADMAP.md) &middot;
Every design decision and why: [`sota_decisions.md`](docs/references/sota_decisions.md)

## System architecture

<img src="docs/assets/img/architecture.svg" alt="Two-layer control architecture">
...
<img src="docs/assets/img/concepts.svg" alt="LIF neuron, STDP, R-STDP, memristor analogy">
...
<div class="gif-row">
<figure><img src="archive/P1_go2_mujoco/stand.gif" alt="Go2 standing under PD control"><figcaption class="cap">D1: standing, PD control</figcaption></figure>
<figure><img src="archive/D3a_policy_export_windows/walk_windows.gif" alt="Go2 walking under the exported policy"><figcaption class="cap">D2/D3a: walking, exported policy</figcaption></figure>
<figure><img src="archive/D3a_policy_export_windows/fig_windows_tracking.png" alt="Velocity tracking, Windows export"><figcaption class="cap">velocity-tracking parity, train vs. deploy</figcaption></figure>
</div>
...
Details: [`D2_go2_rl_go2model`](archive/D2_go2_rl_go2model), [`D3a_policy_export_windows`](archive/D3a_policy_export_windows), [`D3_go2_nav_env`](archive/D3_go2_nav_env)
...
Full write-ups: [`M5_full_comparison`](archive/M5_full_comparison), [`M4b_extras`](archive/M4b_extras), [`M6_energy`](archive/M6_energy), [`M4b_terrain_walk_compare`](archive/M4b_terrain_walk_compare)
...
<div class="gif-row">
<figure><img src="archive/L4_gait_check/dagger_walk_forward_v3.gif" alt="Spiking Go2 walking, robust"><figcaption class="cap">final spiking walker, DAgger-robustified</figcaption></figure>
<figure><img src="archive/L5_energy/sparse_t5_v3_walk.gif" alt="Sparse T5 spiking walker"><figcaption class="cap">sparsified, T=5, energy-positive</figcaption></figure>
<figure><img src="archive/L4_gait_check/fig_distilled_gait.png" alt="gait diagnostic figure"></figure>
</div>
...
Full write-ups: [`L4_gait_check`](archive/L4_gait_check), [`L5_energy`](archive/L5_energy)
...
Every non-trivial bug: [`docs/debug-log`](docs/debug-log/).
Every design decision: [`docs/references/sota_decisions.md`](docs/references/sota_decisions.md).
...
co-processor. Full detail: [`ROADMAP.md`](ROADMAP.md).
